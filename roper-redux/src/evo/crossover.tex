...
\ref{orgb76ae83}) the parents' crossover masks: crossover may occur (only) at
those sites (mod 64) where the combined mask has a 1.

\lstset{language=rust,label=org02e68b5,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=orgf927b9f,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=org31e8a38,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=rust,label=org7e9046e,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
extern crate rand;
use self::rand::{Rng};
use gen::*;
...
\label{sec:orga4cec05}
\lstset{language=rust,label=orgd7cb406,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
