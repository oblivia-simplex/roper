...
\begin{frame}{\theframenumber. Weird Machines}
  \BackgroundImage[0.15]{../images/macgyver2-transparent.png}
  \begin{itemize}
    \item ``Exploitation is setting up, instantiating, and programming a weird
      machine.'' -- Halvar Flake @ Infiltrate, 2011
  \end{itemize}
\end{frame}

\begin{frame}{\theframenumber. Evolving Code for Weird Machines}
  \BackgroundImage[0.15]{../images/lifefindsaway.png}
