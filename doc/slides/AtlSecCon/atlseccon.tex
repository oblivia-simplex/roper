...
\begin{frame}{\theframenumber. Snek!}
  ...
  Please join me in this prayer to the demo gods.
...
\begin{frame}{\theframenumber. Horizons and Applications}
  ...
  \item EVIL: a component of complex, context-sensitive malware, on the scale of Stuxnet, using feature-recognizing ROP-chains to sense weaknesses or opportunities in a network 
  \end{itemize}
\end{frame}
